...
<a href="{{ route('user.register') }}" class="block py-2 hover:text-blue-600">Sign Up</a>
  ...
  <div id="mobile-menu" class="md:hidden hidden px-4 pb-4 space-y-2">
    <a href="{{ url('/home') }}" class="block py-2 hover:text-blue-600">HOME</a>
    <a href="{{ url('/about') }}" class="block py-2 hover:text-blue-600">ABOUT</a>
...
<a href="{{ route('products.bracelets') }}" class="block py-1 hover:text-blue-600">Bracelets</a>
    ...
    @auth
      <a href="{{ route('profile.show') }}" class="block py-2 hover:text-blue-600 flex items-center space-x-1">
        <i class="fa fa-user text-xl"></i>
        <span>Profile</span>
      </a>
      <form method="POST" action="{{ route('logout') }}">
    ...
    @else
    <a href="{{ route('user.login') }}" class="hover:text-blue-600">Sign In</a>
